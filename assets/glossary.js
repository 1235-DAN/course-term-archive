...
(function () {
  ...
  function mountPortal() {
    ...
    root.innerHTML = [
      ...
      '新增名詞：打開 <code>data/&lt;科目&gt;.js</code>，複製一筆 term 物件改內容即可。',
      '新增科目：複製 <code>data/calculus.js</code> 成新檔、換掉 id／name／hue／terms，',
      '再複製一份科目頁 HTML，並把兩個 <code>&lt;script&gt;</code> 加進 <code>index.html</code>。',
      '詳細步驟見資料夾內的 <code>README.md</code>。</p>',
      '</main>',
      '<footer class="wrap foot">',
